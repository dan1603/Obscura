...
object MocUtil {
    private const val TAB_FEED = "TAB_FEED"
    private const val CREATED_THEMES = "created_themes"
    private const val FOLLOWED_THEMES = "followed_themes"
    private const val TAB_PEOPLE = "TAB_PEOPLE"
    private const val TAB_MESSAGES = "TAB_MESSAGES"
    ...
    fun mocListThemes(): List<ThemeEntity> {
        ...
        val entity1=ThemeEntity(1, CARD_EVENT, ("$CARD_EVENT item 1"), imageUrl1, mocEventShortDescription, ("$CARD_EVENT category 1")).apply { this.screenType = TAB_FEED }
        list.add(entity1)
        ...
        val entity2=ThemeEntity(2, CARD_ARTICLE, ("Plane article"), imageUrl2, mocArticleShortDescription, ("$CARD_ARTICLE category 2")).apply { this.screenType = TAB_FEED }
        list.add(entity2)
        ...
        val entity3=ThemeEntity(3, CARD_EVENT, ("$CARD_EVENT item 3"), imageUrl3, mocEventShortDescription, ("$CARD_EVENT category 3")).apply { this.screenType = TAB_FEED }
        list.add(entity3)
        val imageUrl4 = "https://www.rako.cz/file/edee/realizace/random/v_random2_7168.jpg"
        val entity4=ThemeEntity(4, CARD_ARTICLE, ("Interier article"), imageUrl4, mocArticleShortDescription, ("$CARD_ARTICLE category 4")).apply { this.screenType = TAB_FEED }
        list.add(entity4)
        val imageUrl5 = "https://www.comecreationsgroup.pl/wp/wp-content/uploads/2016/01/event.jpg"
        val entity5=ThemeEntity(5, CARD_EVENT, ("$CARD_EVENT item 5"), imageUrl5, mocEventShortDescription, ("$CARD_EVENT category 5")).apply { this.screenType = TAB_FEED }
        list.add(entity5)
        val imageUrl6 = "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRKsJoGKlOJnxl-GNgfUtluGobgx_M8JBdsng&usqp=CAU"
        val entity6=ThemeEntity(6, CARD_ARTICLE, ("Mouse article"), imageUrl6, mocArticleShortDescription, ("$CARD_ARTICLE category 6")).apply { this.screenType = TAB_FEED }
        list.add(entity6)
        ...
        val entity7=ThemeEntity(7, CARD_EVENT, ("$CARD_EVENT item 7"), imageUrl7, mocEventShortDescription, ("$CARD_EVENT category 7")).apply { this.screenType = TAB_FEED }
        list.add(entity7)
        val imageUrl8 = "https://www.hackingwithswift.com/uploads/matrix.jpg"
        val entity8=ThemeEntity(8, CARD_ARTICLE, ("Hacking article"), imageUrl8, mocArticleShortDescription, ("$CARD_ARTICLE category 8")).apply { this.screenType = TAB_FEED }
        list.add(entity8)
        val imageUrl9 = "https://www.konferencje.pl/media/cache/article_horizontal/a/4/d/a/a4da205cb484d7f4b0e6b9f2b0f1680a.jpg"
        val entity9=ThemeEntity(9, CARD_EVENT, ("$CARD_EVENT item 9"), imageUrl9, mocEventShortDescription, ("$CARD_EVENT category 9")).apply { this.screenType = TAB_FEED }
        list.add(entity9)
        val imageUrl10 = "https://www.mandysam.com/img/random.jpg"
        val entity10=ThemeEntity(10, CARD_ARTICLE, ("Looking article"), imageUrl10, mocArticleShortDescription, ("$CARD_ARTICLE category 10")).apply { this.screenType = TAB_FEED }
        list.add(entity10)
        val imageUrl11 = "https://megajet.home.pl/autoinstalator/wordpressplugins1/wp-content/uploads/2020/01/event-Lagerdere-135.jpg"
        val entity11=ThemeEntity(11, CARD_EVENT, ("$CARD_EVENT item 11"), imageUrl11, mocEventShortDescription, ("$CARD_EVENT category 11")).apply { this.screenType = TAB_FEED }
        list.add(entity11)
        val imageUrl12 = "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSUPiYB8dCdTJN7DTmcliXhmof21Wdy0RIqng&usqp=CAU"
        val entity12=ThemeEntity(12, CARD_ARTICLE, ("Security article"), imageUrl12, mocArticleShortDescription, ("$CARD_ARTICLE category 12")).apply { this.screenType = CREATED_THEMES }
        list.add(entity12)
        ...
        val entity13=ThemeEntity(13, CARD_EVENT, ("$CARD_EVENT item 13"), imageUrl13, mocEventShortDescription, ("$CARD_EVENT category 12")).apply { this.screenType = CREATED_THEMES }
        list.add(entity13)
        val imageUrl14 = "https://jadziajedzie.files.wordpress.com/2020/05/img_20190824_113949-2.jpg?w=870&h=773&crop=1"
        val entity14=ThemeEntity(14, CARD_ARTICLE, ("Travel article"), imageUrl14, mocArticleShortDescription, ("$CARD_ARTICLE category 14")).apply { this.screenType = CREATED_THEMES }
        list.add(entity14)
        val imageUrl15 = "https://www.argentum-event.pl/wp-content/uploads/2019/05/O-nas-zesp%C3%B3%C5%82-Argentum-Event-4.jpg"
        val entity15=ThemeEntity(15, CARD_EVENT, ("$CARD_EVENT item 15"), imageUrl15, mocEventShortDescription, ("$CARD_EVENT category 15")).apply { this.screenType = CREATED_THEMES }
        list.add(entity15)
        val imageUrl16 = "https://media-cdn.tripadvisor.com/media/photo-s/19/9e/c0/32/random-restaurant.jpg"
        val entity16=ThemeEntity(16, CARD_ARTICLE, ("Food article"), imageUrl16, mocArticleShortDescription, ("$CARD_ARTICLE category 16")).apply { this.screenType = CREATED_THEMES }
        list.add(entity16)
        val imageUrl17 = "https://imagazine.pl/wp-content/uploads/2020/09/Apple-Special-Event-September-2020.jpg"
        val entity17=ThemeEntity(17, CARD_EVENT, ("Apple event"), imageUrl17, mocEventShortDescription, ("$CARD_EVENT category 17")).apply { this.screenType = CREATED_THEMES }
        list.add(entity17)
        ...
        val entity18=ThemeEntity(18, CARD_ARTICLE, ("Choice article"), imageUrl18, mocArticleShortDescription, ("$CARD_ARTICLE category 18")).apply { this.screenType = FOLLOWED_THEMES }
        list.add(entity18)
        val imageUrl19 = "https://gamingsociety.pl/wp-content/uploads/2020/06/Fortnite-letni-event.jpg"
        val entity19=ThemeEntity(19, CARD_EVENT, ("Fortnite event"), imageUrl19, mocEventShortDescription, ("$CARD_EVENT category 19")).apply { this.screenType = FOLLOWED_THEMES }
        list.add(entity19)
        val imageUrl20 = "https://s26552.pcdn.co/wp-content/uploads/2020/04/dc_neighborhood_news-11.jpg"
        val entity20=ThemeEntity(20, CARD_ARTICLE, ("Dog article"), imageUrl20, mocArticleShortDescription, ("$CARD_ARTICLE category 20")).apply { this.screenType = FOLLOWED_THEMES }
        list.add(entity20)
        val imageUrl21 = "https://koszalininfo.pl/wp-content/uploads/2019/09/event-800x445.jpg"
        val entity21=ThemeEntity(21, CARD_EVENT, ("Line event"), imageUrl21, mocEventShortDescription, ("$CARD_EVENT category 21")).apply { this.screenType = FOLLOWED_THEMES }
        list.add(entity21)
        val imageUrl22 = "https://randomseed.pl/pod/randomself/random-self.jpg"
        val entity22=ThemeEntity(22, CARD_ARTICLE, ("Theater article"), imageUrl22, mocArticleShortDescription, ("$CARD_ARTICLE category 22")).apply { this.screenType = FOLLOWED_THEMES }
        list.add(entity22)
        val imageUrl23 = "https://www.cclep.eu/wp-content/uploads/2018/05/cropped-banner1-3.jpg"
        val entity23=ThemeEntity(23, CARD_EVENT, ("$CARD_EVENT item 23"), imageUrl23, mocEventShortDescription, ("$CARD_EVENT category 23")).apply { this.screenType = FOLLOWED_THEMES }
        list.add(entity23)
        val imageUrl24 = "https://mlinpl.pl/wp-content/uploads/2019/11/algorytm-random-forest-.jpg"
        val entity24=ThemeEntity(24, CARD_ARTICLE, ("Nature article"), imageUrl24, mocArticleShortDescription, ("$CARD_ARTICLE category 24")).apply { this.screenType = FOLLOWED_THEMES }
        list.add(entity24)
        ...
        val entity25=ThemeEntity(25, CARD_EVENT, ("$CARD_EVENT item 25"), imageUrl25, mocEventShortDescription, ("$CARD_EVENT category 25")).apply { this.screenType = FOLLOWED_THEMES }
        list.add(entity25)
    ...
    fun mocListMessages(): List<MessagesEntity> {
        ...
        val entity1=MessagesEntity(1, 1, "Vanessa Hodgson", getMessageList(1)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity1)
        val entity2=MessagesEntity(2, 2, "Jagoda Cleveland", getMessageList(2)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity2)
        val entity3=MessagesEntity(3, 3, "Finley Bowers", getMessageList(3)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity3)
        val entity4=MessagesEntity(4, 4, "Alison Mcpherson", getMessageList(4)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity4)
        val entity5=MessagesEntity(5, 5, "Cassian Hartley", getMessageList(5)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity5)
        val entity6=MessagesEntity(6, 6, "Zaina Daniels", getMessageList(6)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity6)
        val entity7=MessagesEntity(7, 7, "Kason Harvey", getMessageList(7)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity7)
        val entity8=MessagesEntity(8, 8, "Christian Lewis", getMessageList(8)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity8)
        val entity9=MessagesEntity(9, 9, "Suraj Wallace", getMessageList(9)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity9)
        val entity10=MessagesEntity(10, 10, "Hollie Hill", getMessageList(10)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity10)
        val entity11=MessagesEntity(11, 11, "Lacie Hollis", getMessageList(11)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity11)
        val entity12=MessagesEntity(12, 12, "Adnan Braun", getMessageList(12)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity12)
        val entity13=MessagesEntity(13, 13, "Victoria Whitehead", getMessageList(13)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity13)
        val entity14=MessagesEntity(14, 14, "Ari Needham", getMessageList(14)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity14)
        val entity15=MessagesEntity(15, 15, "Sadia Parkinson", getMessageList(15)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity15)
        val entity16=MessagesEntity(16, 16, "Giuseppe Mcfarland", getMessageList(16)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity16)
        val entity17=MessagesEntity(17, 17, "Jerry Vo", getMessageList(17)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity17)
        val entity18=MessagesEntity(18, 18, "Ayaz Ramsay", getMessageList(18)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity18)
        val entity19=MessagesEntity(19, 19, "Leonard James", getMessageList(19)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity19)
        val entity20=MessagesEntity(20, 20, "Millie-Mae Mcgill", getMessageList(20)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity20)
        val entity21=MessagesEntity(21, 21, "Israr Bullock", getMessageList(21)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity21)
        val entity22=MessagesEntity(22, 22, "Lloyd Parker", getMessageList(22)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity22)
        val entity23=MessagesEntity(23, 23, "Arlene Cooley", getMessageList(23)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity23)
        val entity24=MessagesEntity(24, 24, "Esmay Lott", getMessageList(24)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity24)
        val entity25=MessagesEntity(25, 25, "Kush Jennings", getMessageList(25)).apply { this.screenType = TAB_MESSAGES }
        list.add(entity25)
